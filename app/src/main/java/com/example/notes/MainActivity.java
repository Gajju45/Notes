...
import com.example.notes.authentication.LogIn;
import com.example.notes.authentication.Register;
import com.example.notes.model.Note;
import com.example.notes.note.AddNote;
import com.example.notes.note.EditNote;
import com.example.notes.note.NotesDetail;
...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            protected void onBindViewHolder(@NonNull NoteViewHolder noteViewHolder, final int i, @NonNull final Note note) {
                ...
                noteViewHolder.view.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        // Toast.makeText(v.getContext(), "The itm Is Clicked ", Toast.LENGTH_SHORT).show();
                        Intent i = new Intent(v.getContext(), NotesDetail.class);
                ...
                menuIcon.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(final View v) {
                        ...
                        menu.setGravity(Gravity.END);//LeftSidePopup opn
        ...
        View heaerView = nav_View.getHeaderView(0);
        TextView username = heaerView.findViewById(R.id.userDisplayName);
        TextView userEmail = heaerView.findViewById(R.id.userDisplayEmail);
        if (user.isAnonymous()) {
    ...
    private void displayAlert() {
        AlertDialog.Builder warning = new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Reegister Now", new DialogInterface.OnClickListener() {
                    @Override
